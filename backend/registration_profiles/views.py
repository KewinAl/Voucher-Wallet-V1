...
from project.settings import DEFAULT_FROM_EMAIL, FRONTEND_URL
...
class RegistrationView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        send_mail(
            'Validation Code',
            'Validation code: {}. Verify at this link: {}/registration_verification/'.format(
                registration.code, FRONTEND_URL),
            DEFAULT_FROM_EMAIL,
            [registration.email],
            fail_silently=False,
        )
...
class ValidationView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        User.objects.create_user(
            ...
            first_name=serializer.validated_data["location"])
